...
let erro = document.querySelector('#erro') as HTMLDivElement;
let erroLogin = document.querySelector('#erroLogin') as HTMLDivElement;
let sucesso = document.querySelector('#sucesso') as HTMLDivElement;
